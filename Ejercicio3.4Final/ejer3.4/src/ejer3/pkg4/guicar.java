 ...
 * @author USER
 */
public class guicar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Bienvenido Panita");

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel6.setText("al Concesionario ");

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel8.setText("Capibara Life ");
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
        if (car.isNumber(textmodelo.getText())&&car.isNumber(kilometraje.getText())) {
            car.listado(textmarca.getText(),textcolor.getText(),Integer.parseInt(textmodelo.getText()), Integer.parseInt(kilometraje.getText()));  
            textmodelo.setText("");
            textmarca.setText("");
            textcolor.setText("");
            kilometraje.setText("");
        ...
        switch(o){
            ...
            case 0:
                switch(t){
                    default:
                    case 0:
                        car.mergeSort2list(car.getModelo(), o,car.getModelo().size()-1);
                        break;
                    case 1:
                        car.mergeSort2list(car.getKilo(), o,car.getKilo().size()-1);
                        break;
                }
                break;
            ...
            case 1:
                switch(t){
                    case 0:
                       car.bubbles2list(car.getModelo());
                        break;
                    case 1:
                       car.bubbles2list(car.getKilo());
                }
                break;
        }
        System.out.println("a");
        table1.setRowCount(0);
        table1.setRowCount(car.getMarca().size());
        for (int i = 0; i < car.getMarca().size(); i++) {
            table1.setValueAt(car.getMarca().get(i), i, 0);
            table1.setValueAt(car.getModelo().get(i), i, 1);
            table1.setValueAt(car.getColor().get(i), i, 2);
            table1.setValueAt(car.getKilo().get(i), i, 3);
 ...
 // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(guicar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
